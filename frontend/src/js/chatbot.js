...
export class AIChatbot {
  ...
  getIconSvg(name) {
    const icons = {
      'bot': `<svg viewBox="0 0 24 24" style="width: 26px; height: 26px; fill: none; stroke: currentColor; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; display: block;"><path d="M12 6V3m-3 0h6" /><rect x="3" y="6" width="18" height="12" rx="4" fill="currentColor" fill-opacity="0.1" /><circle cx="8" cy="11.5" r="1.5" fill="currentColor" stroke="none" /><circle cx="16" cy="11.5" r="1.5" fill="currentColor" stroke="none" /><path d="M9.5 14.5c1 1 4 1 5 0" /><circle cx="5.5" cy="12.5" r="1" fill="var(--accent-rose)" stroke="none" /><circle cx="18.5" cy="12.5" r="1" fill="var(--accent-rose)" stroke="none" /></svg>`,
